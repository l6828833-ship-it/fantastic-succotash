...
// Anything else (publishable "pk_", or an unrelated value like "mk_") cannot
...
export async function createStripeCheckout(opts: {
  ...
  // Guard against a wrong value in STRIPE_SECRET_KEY (e.g. a publishable "pk_"
  // key or some other token). Stripe rejects these with a cryptic error, so
